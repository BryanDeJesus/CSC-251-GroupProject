...
//        PrintLists(ClassList, CreditsList);
    ...
    JTextField manNumPeople = new JTextField();
    ...
    private void initComponents()
    {
        ...
        setMinimumSize(new java.awt.Dimension(958, 641));
        ...
        partyNumLabel.setBounds(20, 120, 230, 14);
        getContentPane().add(partyNumField);
        partyNumField.setBounds(260, 110, 114, 30);
        ...
        CalculateButton.setBounds(200, 260, 103, 25);
        ...
        CloseButton.setBounds(193, 440, 93, 25);
        ...
        AddNewButton.setBounds(10, 370, 145, 25);
        ...
        jScrollPane1.setBounds(500, 40, 390, 467);
        ...
        DiscountYNLabel.setBounds(50, 190, 160, 14);
        ...
        YesButton.setBounds(280, 190, 43, 23);
        ...
        PrintRecordsButton.setBounds(12, 440, 154, 25);
        ...
        PrintSingleRecordButton.setBounds(12, 408, 153, 25);
        ...
        AutoGenerateResLabel.setBounds(20, 70, 178, 28);
        ...
        AutoGenResYButton.setBounds(280, 80, 43, 23);
        ...
        AutoGenResNButton.setBounds(330, 80, 40, 23);
        ...
        GroupNumComboBox.setBounds(270, 150, 40, 20);
        ...
        DialogBoxPromptButton.setBounds(320, 150, 115, 23);
        ...
        CalculatePriceButton.setBounds(310, 260, 126, 25);
...
// </editor-fold>
    ...
    public void ManualResItemEntry(int numGroups)
    {
        Object[] items =
        {
            ...
            "Chairs: ", chairInput,
            "OR",
            "Number of People: ", manNumPeople
        };
        for(int i = 0; i < numGroups; ++i)
        {
            JOptionPane.showConfirmDialog(null,items,"Enter number of items for Group" + (i + 1) ,JOptionPane.OK_CANCEL_OPTION);
            try
            {
                int tables = Integer.parseInt(tableInput.toString());
                int chairs = Integer.parseInt(chairInput.toString());
                int people = Integer.parseInt(manNumPeople.toString());
                totalTables += tables;
                totalChairs += chairs;
                if(chairInput == null && tableInput == null && manNumPeople != null)
                {
