...
//        PrintLists(ClassList, CreditsList);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(PrintSingleRecordButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(27, 27, 27)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(44, 44, 44)))
                        .addGap(26, 26, 26)
                        .addComponent(GroupNumQLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                            .addComponent(AutoGenResYButton)
                                            .addComponent(AutoGenResNButton))
                                        .addComponent(AutoGenerateResLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(63, 63, 63)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                            ...
                                            .addComponent(DialogBoxPromptButton))))
                                .addGap(101, 448, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    {//GEN-HEADEREND:event_DialogBoxPromptButtonActionPerformed
        ...
        numGroups = Integer.parseInt(GroupNumComboBox.toString());
        Object[] items = 
        {
            "Tables: ", tableInput,
            "Chairs: ", chairInput
        ...
        {
            JOptionPane.showConfirmDialog(null,items,"Enter Number of Tables and Chairs Needed ",JOptionPane.OK_CANCEL_OPTION);
//            //input = JOptionPane.showInputDialog("Enter your letter grade: ");
...
//                chooseInput, chooseInput[0]);
    ...
    public void PrintReport(String DisplayText) throws IOException
    {
        ...
        {
            for (String record : DisplayReportList)
            {
